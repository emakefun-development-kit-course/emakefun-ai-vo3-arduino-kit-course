...
针对Arduino编程，我们专门进行了优化，简化了编写MCP工具的难度，提供了标准的接口，简化了代码逻辑，使开发人员更专注于MCP功能，请参考文档：[优化版 AI VOX Engine MCP 编程指南](./03_编程指南_优化版AI-VOX3%20Engine%20MCP%20介绍.md)，后续所有示例都基于优化版MCP工具设计开发。
